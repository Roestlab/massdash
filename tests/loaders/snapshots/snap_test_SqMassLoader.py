...
snapshots['TestSqMassLoader::test_loadTransitionGroups 1'] = {
    GenericRepr('SqMassDataAccess(filename=../test_data/xics/test_chrom_1.sqMass)'): GenericRepr('<massdash.structs.TransitionGroup.TransitionGroup object at 0x100000000>'),
    GenericRepr('SqMassDataAccess(filename=../test_data/xics/test_chrom_2.sqMass)'): GenericRepr('<massdash.structs.TransitionGroup.TransitionGroup object at 0x100000000>')
}
