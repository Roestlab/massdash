...
.. toctree::
   ...
   python_docs/Quick Start
   python_docs/Loading Data
   python_docs/Plotting1D
   python_docs/Advanced Plotting
   python_docs/Peak Picking

MashDash is always looking for contributors. If you have a feature that you wish to add please open a pull request on our github `here <https://github.com/Roestlab/massdash/pulls>`_.
