...
class GenericLoader(ABC):
    ...
    '''
    def __init__(self, rsltsFile: str, dataFiles: Union[str, List[str]], libraryFile: str = None, rsltsFileType: Literal['OpenSWATH', 'DIA-NN', 'Spectronaut', 'DreamDIA'] = 'DIA-NN', verbose: bool=False):
